...
- [ ] Rodar os scripts de instalação (`scripts/02_install_alpine_deps.sh`).
- [ ] Preencher o `.env` de produção.
- [ ] Rodar `./scripts/setup.sh`.
- [ ] Iniciar o Docker (Postgres) e rodar `./scripts/04_register_lights.py` para popular o banco.
