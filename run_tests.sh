...
echo -e "\n${GREEN}1. Executando Pytest (API, Web, Auth, Config, Reliability, Telegram, Backup)...${NC}"
pytest tests/test_api.py tests/test_web_api.py tests/test_timezone.py tests/test_auth.py tests/test_web_config.py tests/test_command_reliability.py tests/test_telegram.py tests/test_backup.py -v | tee logs/tests.log
