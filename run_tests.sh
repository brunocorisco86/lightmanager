...
./.venv/bin/python3 -m pytest tests/test_api.py tests/test_web_api.py tests/test_timezone.py tests/test_auth.py tests/test_web_config.py tests/test_command_reliability.py tests/test_telegram.py tests/test_backup.py tests/test_bot_integrity.py tests/test_weather_sync.py -v | tee logs/tests.log
